...
%        365, AAE 364, AAE 421).
        ...
        \item \itbf{Course Development:} Developed and demonstrated parameter estimation and robust control implementation procedures for refrigeration system with variable speed compressor and flow control valve (non-minimum phase system) using STM32 Discovery board as possible guided final project for the future course offerings of ME 586.
\end{itemize}
%===
\medskip
%===
\itbf{Relevant Course Work:} Vehicle Dynamics, Multivariable Systems and Robust Control, Adaptive Control, Estimation Theory, System Identification and Nonlinear Systems. Relevant course projects include:
\begin{itemize}
